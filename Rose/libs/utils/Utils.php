...
class Utils implements  Listener {
 ...
 public static function addFireworks(Position $pos){
		...
		$data = new Fireworks();
	$data->addExplosion(Fireworks::TYPE_SMALL_SPHERE, Fireworks::COLOR_WHITE, Fireworks::COLOR_WHITE, false, false);
		$data->setFlightDuration(1);

		$nbt = Entity::createBaseNBT($pos, null, lcg_value() * 360, 90);
		$rocket = new FireworksRocket($pos->getLevel(), $nbt, $data);
		$rocket->spawnToAll();
	}
	 public static function addYellow(Position $pos){
		$data = new Fireworks();
	$data->addExplosion(Fireworks::TYPE_SMALL_SPHERE, Fireworks::COLOR_YELLOW, Fireworks::COLOR_YELLOW, false, false);
	$data->setFlightDuration(1);
	 ...
	 public static function addGold(Position $pos){
		$data = new Fireworks();
	$data->addExplosion(Fireworks::TYPE_SMALL_SPHERE, Fireworks::COLOR_GOLD, Fireworks::COLOR_GOLD, false, false);
	$data->setFlightDuration(1);
	 ...
	 public static function addMythic(Position $pos){
		$data = new Fireworks();
	$data->addExplosion(Fireworks::TYPE_SMALL_SPHERE, Fireworks::COLOR_RED, Fireworks::COLOR_RED, false, false);
	$data->setFlightDuration(1);
	 ...
	 public static function addSpecial(Position $pos){
		$data = new Fireworks();
	$data->addExplosion(Fireworks::TYPE_SMALL_SPHERE, Fireworks::COLOR_PINK, Fireworks::COLOR_PINK, false, false);
	$data->setFlightDuration(1);
